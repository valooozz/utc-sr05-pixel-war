...
go run app-control -n C1 -nbsites 5 < /tmp/in_C1 > /tmp/out_C1 &
go run app-net -n N1 -r '[3,2]' -nbsites 5 -port $portN1 -v 2 < /tmp/in_N1 > /tmp/out_N1 &
...
go run app-control -n C2 -nbsites 5 < /tmp/in_C2 > /tmp/out_C2 &
go run app-net -n N2 -r '[1,3]' -nbsites 5 -port $portN2 -v 2 < /tmp/in_N2 > /tmp/out_N2 &
...
go run app-control -n C3 -nbsites 5 < /tmp/in_C3 > /tmp/out_C3 &
go run app-net -n N3 -r '[2,4;4,1]' -nbsites 5 -port $portN3 -v 3 < /tmp/in_N3 > /tmp/out_N3 &
...
go run app-control -n C4 -nbsites 5 < /tmp/in_C4 > /tmp/out_C4 &
go run app-net -n N4 -r '[3,5;5,3]' -nbsites 5 -port $portN4 -v 2 < /tmp/in_N4 > /tmp/out_N4 &
...
go run app-control -n C5 -nbsites 5 < /tmp/in_C5 > /tmp/out_C5 &
go run app-net -n N5 -r '[4,4]' -nbsites 5 -port $portN5 -v 1 < /tmp/in_N5 > /tmp/out_N5 &
...
go run app-net -n N6 -r '[2,2]' -port $portN6 -e inactif -t 19 -c 2 < /tmp/in_N6 > /tmp/out_N6 &
