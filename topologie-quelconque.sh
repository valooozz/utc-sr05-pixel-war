...
go run app-net -n N1 -r '[3,2]' -nbsites 6 < /tmp/in_N1 > /tmp/out_N1 &
...
go run app-net -n N2 -r '[1,6;6,3]' -nbsites 6 < /tmp/in_N2 > /tmp/out_N2 &
open -a "Google Chrome" http://localhost:63340/pixel-war/app-base/frontend/index.html
...
go run app-net -n N3 -r '[2,4;4,1]' -nbsites 6 < /tmp/in_N3 > /tmp/out_N3 &
open -a "Google Chrome" http://localhost:63340/pixel-war/app-base/frontend/index.html
...
go run app-net -n N4 -r '[3,5;5,3]' -nbsites 6 < /tmp/in_N4 > /tmp/out_N4 &
open -a "Google Chrome" http://localhost:63340/pixel-war/app-base/frontend/index.html

#SITE 5
go run app-base -n A5 -m g -port 4448 < /tmp/in_A5 > /tmp/out_A5 &
#go run app-base -n A5 < /tmp/in_A5 > /tmp/out_A5 &
go run app-control -n C5 -nbsites 6 < /tmp/in_C5 > /tmp/out_C5 &
go run app-net -n N5 -r '[4,4]' -nbsites 6 < /tmp/in_N5 > /tmp/out_N5 &
open -a "Google Chrome" http://localhost:63340/pixel-war/app-base/frontend/index.html


#SITE 6
go run app-base -n A6 -m g -port 4449 < /tmp/in_A6 > /tmp/out_A6 &
#go run app-base -n A5 < /tmp/in_A5 > /tmp/out_A5 &
go run app-control -n C6 -nbsites 6 < /tmp/in_C6 > /tmp/out_C6 &
go run app-net -n N6 -r '[2,2]' -nbsites 6 < /tmp/in_N6 > /tmp/out_N6 &
open -a "Google Chrome" http://localhost:63340/pixel-war/app-base/frontend/index.html
