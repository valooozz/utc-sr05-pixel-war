...
go run app-net -n N1 -r '[3,2]' -nbsites 6 -port $portN1 -v 2 < /tmp/in_N1 > /tmp/out_N1 &
...
go run app-net -n N2 -r '[1,6;6,3]' -nbsites 6 -port $portN2 -v 3 < /tmp/in_N2 > /tmp/out_N2 &
...
go run app-net -n N3 -r '[2,4;4,1]' -nbsites 6 -port $portN3 -v 3 < /tmp/in_N3 > /tmp/out_N3 &
...
go run app-net -n N4 -r '[3,5;5,3]' -nbsites 6 -port $portN4 -v 2 < /tmp/in_N4 > /tmp/out_N4 &
...
go run app-net -n N5 -r '[4,4]' -nbsites 6 -port $portN5 -v 1 < /tmp/in_N5 > /tmp/out_N5 &
...
go run app-net -n N6 -r '[2,2]' -nbsites 6 -port $portN6 -v 1 -q 15 -c 2 < /tmp/in_N6 > /tmp/out_N6 &
