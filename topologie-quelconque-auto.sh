...
#SITE 2
#go run app-base -n A2 -m g -port 4446 < /tmp/in_A2 > /tmp/out_A2 &
...
#SITE 3
#go run app-base -n A3 -m g -port 4448 < /tmp/in_A3 > /tmp/out_A3 &
...
#SITE 4
#go run app-base -n A4 -m g -port 4450 < /tmp/in_A4 > /tmp/out_A4 &
...
#SITE 5
#go run app-base -n A5 -m g -port 4452 < /tmp/in_A5 > /tmp/out_A5 &
...
#SITE 6
#go run app-base -n A6 -m g -port 4454 < /tmp/in_A6 > /tmp/out_A6 &
