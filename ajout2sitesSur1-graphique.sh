...
go run app-net -n N5 -r '[2,2]' -port $portN5 -e inactif -t 20 -c 2 < /tmp/in_N5 > /tmp/out_N5 &
...
go run app-net -n N6 -r '[2,2]' -port $portN6 -e inactif -t 20 -c 2 < /tmp/in_N6 > /tmp/out_N6 &
