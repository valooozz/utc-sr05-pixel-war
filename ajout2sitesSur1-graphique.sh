...
go run app-net -n N5 -r '[2,2]' -port $portN5 -e inactif -t 15 -c 2 < /tmp/in_N5 > /tmp/out_N5 &
...
#CONNEXIONS INTERSITES
cat /tmp/out_N2 | tee /tmp/in_C2 | tee /tmp/in_N3 | tee /tmp/in_N5 | tee /tmp/in_N6 > /tmp/in_N1 &
...
#CONNEXIONS INTERSITES
cat /tmp/out_N5 | tee /tmp/in_C5 > /tmp/in_N2 &

cat /tmp/out_A6 > /tmp/in_C6 &
cat /tmp/out_C6 | tee /tmp/in_A6 > /tmp/in_N6 &
#CONNEXIONS INTERSITES
cat /tmp/out_N6 | tee /tmp/in_C6 > /tmp/in_N2 &